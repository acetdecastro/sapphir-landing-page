  ...
  return (
    <section className="p-8 flex flex-col items-center bg-gradient-to-b from-gray-50 md:px-14">
      <article className="flex flex-col items-center space-y-6 md:w-4/5">
        ...
        <button
          type="button"
          className="select-none bg-gradient-to-bl w-56 from-indigo-500 sapphir-bg-color uppercase font-bold tracking-widest text-xs py-3 text-gray-100 rounded-md md:w-2/6 xl:w-56 xxl:w-48 focus:outline-none transition transform ease-in duration-200 hover:scale-105"
        >
          Apply now
        </button>
      </article>
