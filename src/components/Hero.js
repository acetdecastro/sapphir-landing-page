...
const Hero = () => {
  return (
    <div className="relative overflow-hidden flex flex-col px-8 space-y-8 md:flex-row md:px-14 md:pb-12">
      <div className="absolute z-0 top-0 right-0 bottom-0 left-auto transform mt-24 -mr-16 rotate-45 md:-mr-4 md:mt-8">
        <HeroPattern className="h-64 w-64 opacity-25 md:h-48 md:w-48" />
      </div>

      <div className="space-y-10">
        <div className="space-y-6">
          <h1 className="text-3xl font-extrabold text-gray-900 leading-8 md:text-4xl">
            Hassle free loaning
          </h1>
          <div className="flex flex-col space-y-2">
            <span className="text-lg font-semibold text-gray-600 leading-5">
      ...
      <Wallet className="h-64 w-64 md:absolute inset-y-auto left-auto right-0 md:pr-12 md:pb-32.5 md:h-88 md:w-88" />
    </div>
  );
};
