...
const Support = () => {
  return (
    <section className="relative pb-64 md:pb-80">
      <img
      ...
      <article className="absolute inset-0 px-8 pt-6 flex flex-col items-center space-y-6 md:pt-14">
        <div className="flex flex-col items-center space-y-2">
          <h3 className="text-2xl font-extrabold text-white leading-8">
            Always by your side
          </h3>
          <span className="leading-5 text-gray-50 opacity-75 tracking-wide text-xs font-medium">
